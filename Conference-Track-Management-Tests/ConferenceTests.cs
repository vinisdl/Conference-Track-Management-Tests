...
namespace Conference_Track_Management_Tests
{
    public class ConferenceTests
    {
        public ConferenceTests()
        {
            ...
            _conf = new Conference(_talks, days);
            _conf.Scheduler.Schedule();
        }
        ...
        {
            return _conf.Days.Sum(day => day.EveningSession.Talks.Count + day.MorningSession.Talks.Count);
        }
        ...
        {
            Assert.Equal(_talks.Count, _conf.Talks.Count);
        }
    }
}